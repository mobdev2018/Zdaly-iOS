...
#import <math.h>
@interface KeyTrendsTableViewCell () {
    BOOL graphDrawn;
}
@end
@implementation KeyTrendsTableViewCell
...
- (IBAction)zoomClicked:(id)sender {
    ...
    graphShowVC.graphDict = self.graphDict;
    [self.keyTrendsVC presentViewController:graphShowVC animated:YES completion:nil];
}
